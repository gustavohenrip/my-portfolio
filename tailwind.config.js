...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'grid-pattern': "linear-gradient(to right, rgb(var(--accent) / 0.05) 1px, transparent 1px), linear-gradient(to bottom, rgb(var(--accent) / 0.05) 1px, transparent 1px)",
        'gradient-radial': 'radial-gradient(var(--tw-gradient-stops))',
        'gradient-conic': 'conic-gradient(from 180deg at 50% 50%, var(--tw-gradient-stops))',
        'cyber-grid': "linear-gradient(90deg, rgb(var(--accent) / 0.1) 1px, transparent 1px), linear-gradient(rgb(var(--accent) / 0.1) 1px, transparent 1px)",
      },
      backgroundSize: {
