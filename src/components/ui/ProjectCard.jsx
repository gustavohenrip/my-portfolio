...
export const ProjectCard = memo(function ProjectCard({ id, title, type, tech, year, image, link, index }) {
        ...
        >
          <div className="relative w-full h-full overflow-hidden border border-accent/30">
            <div
              ...
              style={{ backgroundImage: `url("${encodeURI(resolveAssetUrl(image || '/api/placeholder/300/200'))}")`, filter: 'saturate(0.8)' }}
            />
